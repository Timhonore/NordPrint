...
export class Migration20260823154110 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table if exists "wishlist_item" drop constraint if exists "wishlist_item_customer_id_product_id_variant_id_unique";`);
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_wishlist_item_customer_id_product_id_variant_id_unique" ON "wishlist_item" ("customer_id", "product_id", "variant_id") WHERE deleted_at IS NULL;`);
